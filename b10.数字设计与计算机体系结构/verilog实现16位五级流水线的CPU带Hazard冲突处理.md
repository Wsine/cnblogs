...
![CPUregister](/images/wsine-blog-image148.png)

**该CPU的全部指令一览**

![Op1](/images/wsine-blog-image149.png)
![Op2](/images/wsine-blog-image150.png)
![Op3](/images/wsine-blog-image151.png)

**该CPU的系统框图**

![BlockDiagram](/images/wsine-blog-image152.png)
...
![CPU Control](/images/wsine-blog-image153.png)
...
![IF1](/images/wsine-blog-image154.png)
![IF2](/images/wsine-blog-image155.png)
![IF3](/images/wsine-blog-image156.png)
...
![ID1](/images/wsine-blog-image157.png)
![ID2](/images/wsine-blog-image158.png)
![ID3](/images/wsine-blog-image159.png)
![ID4](/images/wsine-blog-image160.png)

- Execute

时序逻辑，根据不同的运算指令作不同的运算；如果为存储指令则直接转移到下一级寄存器，并将写入指令标记为true；如果为其余指令，则保持当前内容不变

![EX](/images/wsine-blog-image161.png)

- ALU

组合逻辑，根据不同的指令进行不同的运算，得注意SLA和SRA两条指令在verilog里面的做法。同时注意进位操作的处理。详细看代码。

![ALU](/images/wsine-blog-image162.png)

- Memory Access

时序逻辑，只有当LOAD指令需要从Data Memory里面取出内容，其余情况把reg_C传递给reg_C1即可。cf进位标志在此阶段更新。

![MEM](/images/wsine-blog-image163.png)

- Write Back

时序逻辑，对需要写回到寄存器的指令把运算结果写回到寄存器中，其余情况只需让寄存器保持不变

![WB](/images/wsine-blog-image164.png)

- Instruction Memory

组合逻辑，根据地址的读入，输出一条指令

![IM](/images/wsine-blog-image165.png)
...
![DM](/images/wsine-blog-image166.png)

### CPU仿真测试

Testbench内容

![Testbench](/images/wsine-blog-image167.png)
...
![Instructino1](/images/wsine-blog-image168.png)
![Instructino2](/images/wsine-blog-image169.png)
...
![re1](/images/wsine-blog-image170.png)
![re2](/images/wsine-blog-image171.png)
...
![fangzhen](/images/wsine-blog-image172.png)

**三个实用测试**

![Pro13](/images/wsine-blog-image173.jpg)
![Pro14](/images/wsine-blog-image174.jpg)
![Pro15](/images/wsine-blog-image175.jpg)

**一些感言**
刚开始做的时候对Hazard的情况不是很理解，原本以为只需要判断指令的操作数域是否发生冲突就算做完Data Hazard的冲突处理，就像PPT上面的图指示的一样。

![ppt](/images/wsine-blog-image176.png)
